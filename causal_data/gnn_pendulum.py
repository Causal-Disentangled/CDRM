...
def write_data(df_X, args):
    data_dir = './causal_data/pendulum/{}_{}_{}/'.format(args.log_dir, args.ratio, args.epochs)
    fname = 'restore_pendulum_{}'.format(args.epochs)
...
def train_gnn_pendulum(data, args, log_path, device=torch.device('cpu')):
